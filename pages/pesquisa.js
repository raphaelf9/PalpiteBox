...
const onChange = evt =>{
    ...
    return(
        ...
        <PageTitle title= 'Pesquisa'/>
            ...
            <button className="bg-blue-400 my-4 px-20 py-4 font-bold rounded-lg shadow-lg hover:shadow" onClick={save}>Salvar</button>
            </div>}
            {success && <div className="w-1/5 mx-auto">
                <p className="mb-6 text-center bg-blue-100 border-t border-b border-blue-500 text-blue-700 px-4 py-3">Obrigado por participar com sua opinião!</p>
                {
                    retorno.showCoupon &&
                ...
                }
                {
                    ...
                    <div className="text-center border p-4 mb-2">
                        ...
                        <br />
                        <span className="italic">Apresente uma foto dessa tela ou um print no Estabelecimento.</span>
                    </div>
                }
